...
public class databaseDoctruyen extends SQLiteOpenHelper {
    ...
    //  phân quyền: 1. adim  2. người dùng
    private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','admin','admin@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'toan','toan','toan@gmail.com',1)";
    ...
    public void onCreate(SQLiteDatabase dp) {
        // thực hiện câu truy vấn không trả về kết quả

        dp.execSQL( SQLQuery );
        dp.execSQL( SQLQuery1 );
        dp.execSQL( SQLQuery2 );
        dp.execSQL( SQLQuery3 );
        dp.execSQL( SQLQuery4 );
        dp.execSQL( SQLQuery5 );
        dp.execSQL( SQLQuery6 );
        dp.execSQL( SQLQuery7 );
        dp.execSQL( SQLQuery8 );
    }
